...
class Ball(pygame.sprite.Sprite):
    """A class for the ball in the game.
    ...
    def __init__(self, _x=0, _y=0, ball='blue'):
        ...
        Args:
            ...
            ball (str, optional):
                The color of the ball. Defaults to 'blueball.png'.
        """
        super().__init__()
    ...
    def move(self, x=0, y=0):
        """Moves the ball with the move_ip method of the rect object.

        Args:
            x (int, optional):
                The moving distance on x coordinates. Defaults to 0.
            y (int, optional):
                The moving distance on y coordinates. Defaults to 0.
        """
